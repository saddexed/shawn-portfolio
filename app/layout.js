...
export const metadata = {
  ...
  title: {
    default: 'Shaun Beniel Edwin',
    template: '%s // Shaun Beniel Edwin'
  },
  description: 'Cybersecurity, DevSecOps, cloud, and backend development',
  authors: [{ name: 'Shaun Beniel Edwin' }],
  openGraph: {
    type: 'website',
    siteName: 'Shaun Beniel Edwin'
  },
  twitter: {
